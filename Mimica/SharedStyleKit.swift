...
//  Mimica
//
//  Created by Gleb LInnik on 20.08.17.
...
public class SharedStyleKit : NSObject {
    ...
    @objc dynamic public class func drawFavebookButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 60, height: 60), resizing: ResizingBehavior = .aspectFit) {
        ...
        facebookPath.move(to: CGPoint(x: 37.61, y: 15.01))
        facebookPath.addLine(to: CGPoint(x: 33.72, y: 15))
        facebookPath.addCurve(to: CGPoint(x: 26.52, y: 22.38), controlPoint1: CGPoint(x: 29.35, y: 15), controlPoint2: CGPoint(x: 26.52, y: 17.9))
        facebookPath.addLine(to: CGPoint(x: 26.52, y: 25.79))
        facebookPath.addLine(to: CGPoint(x: 22.61, y: 25.79))
        facebookPath.addCurve(to: CGPoint(x: 22, y: 26.4), controlPoint1: CGPoint(x: 22.27, y: 25.79), controlPoint2: CGPoint(x: 22, y: 26.06))
        facebookPath.addLine(to: CGPoint(x: 22, y: 31.33))
        facebookPath.addCurve(to: CGPoint(x: 22.61, y: 31.94), controlPoint1: CGPoint(x: 22, y: 31.67), controlPoint2: CGPoint(x: 22.27, y: 31.94))
        facebookPath.addLine(to: CGPoint(x: 26.52, y: 31.94))
        facebookPath.addLine(to: CGPoint(x: 26.52, y: 44.39))
        facebookPath.addCurve(to: CGPoint(x: 27.13, y: 45), controlPoint1: CGPoint(x: 26.52, y: 44.73), controlPoint2: CGPoint(x: 26.8, y: 45))
        facebookPath.addLine(to: CGPoint(x: 32.24, y: 45))
        facebookPath.addCurve(to: CGPoint(x: 32.85, y: 44.39), controlPoint1: CGPoint(x: 32.58, y: 45), controlPoint2: CGPoint(x: 32.85, y: 44.73))
        facebookPath.addLine(to: CGPoint(x: 32.85, y: 31.94))
        facebookPath.addLine(to: CGPoint(x: 37.42, y: 31.94))
        facebookPath.addCurve(to: CGPoint(x: 38.04, y: 31.33), controlPoint1: CGPoint(x: 37.76, y: 31.94), controlPoint2: CGPoint(x: 38.04, y: 31.67))
        facebookPath.addLine(to: CGPoint(x: 38.04, y: 26.4))
        facebookPath.addCurve(to: CGPoint(x: 37.86, y: 25.97), controlPoint1: CGPoint(x: 38.04, y: 26.24), controlPoint2: CGPoint(x: 37.97, y: 26.08))
        facebookPath.addCurve(to: CGPoint(x: 37.42, y: 25.79), controlPoint1: CGPoint(x: 37.74, y: 25.85), controlPoint2: CGPoint(x: 37.59, y: 25.79))
        facebookPath.addLine(to: CGPoint(x: 32.85, y: 25.79))
        facebookPath.addLine(to: CGPoint(x: 32.85, y: 22.9))
        facebookPath.addCurve(to: CGPoint(x: 34.99, y: 20.81), controlPoint1: CGPoint(x: 32.85, y: 21.51), controlPoint2: CGPoint(x: 33.18, y: 20.81))
        facebookPath.addLine(to: CGPoint(x: 37.61, y: 20.81))
        facebookPath.addCurve(to: CGPoint(x: 38.22, y: 20.2), controlPoint1: CGPoint(x: 37.95, y: 20.81), controlPoint2: CGPoint(x: 38.22, y: 20.54))
        facebookPath.addLine(to: CGPoint(x: 38.22, y: 15.62))
        facebookPath.addCurve(to: CGPoint(x: 37.61, y: 15.01), controlPoint1: CGPoint(x: 38.22, y: 15.28), controlPoint2: CGPoint(x: 37.95, y: 15.01))
        facebookPath.close()
