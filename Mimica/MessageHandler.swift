...
//  Mimica
//
//  Created by Ян Хамутовский on 28.08.17.
...
//		if image != nil {
//			
//			DBProvider.Instance.imageStorageRef.child(senderID + "\(NSUUID().uuidString).jpg").put(image!, metadata: nil) { (metadata: StorageMetadata?, err: Error?) in
//				
//				if err != nil {
